...
_BASIC_URL_ = "https://query2.finance.yahoo.com/v8/finance/chart/"
...
class Quote:
    ...
    def _fetch(self, proxy):
        ...
        result["chart"]["result"][0]["symbol"] = self._data.ticker
        query1_info = next(
            (info for info in result.get("chart", {}).get("result", []) if info["symbol"] == self._data.ticker),
            None,
        )
